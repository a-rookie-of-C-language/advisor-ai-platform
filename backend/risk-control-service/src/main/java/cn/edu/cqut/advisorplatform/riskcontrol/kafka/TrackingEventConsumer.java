...
public class TrackingEventConsumer {
    ...
    public void consume(TrackingEventMessage message) {
        log.info("Received tracking event: userId={}, eventType={}, eventName={}",
                message.getUserId(), message.getEventType(), message.getEventName());
        ...
        try {
            ...
            TrackingEvent event = TrackingEvent.builder()
                    ...
                    .createdAt(LocalDateTime.ofEpochSecond(message.getTimestamp() / 1000, 0, ZoneOffset.UTC))
                    .build();
            ...
            log.error("Failed to process tracking event: userId={}, eventType={}",
                    message.getUserId(), message.getEventType(), e);
        }
    }
}
